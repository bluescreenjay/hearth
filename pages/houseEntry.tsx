...
const ProfileSettings: React.FC = () => {
  ...
  return (
    ...
    <form onSubmit={handleSubmit} className="profile-settings-container">
     ...
     <h1 className="rubik-title">List A Hearth</h1>


      <div className="section">
        <h2 className="section-title">Hearth Photo</h2>
        <input
          type="file"
          accept="image/*"
      ...
      <div className="section">
        ...
        <textarea
          ...
          placeholder="Write a brief description including your location, required duration of stay, and more..."
        />
      </div>
